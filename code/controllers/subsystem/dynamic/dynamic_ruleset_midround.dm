...
/datum/dynamic_ruleset/midround/pirates/proc/send_pirate_threat(list/pirate_selection)
	...
	//send message
	priority_announce("Входящая подпространственная связь. Защищённый канал открыт на всех консолях связи.", "ВНИМАНИЕ: Вам Сообщение", ANNOUNCER_COMMAND_REPORT) // SPLURT EDIT
