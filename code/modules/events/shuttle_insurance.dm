...
/datum/round_event/shuttle_insurance/announce(fake)
	priority_announce("Входящая подпространственная связь. Защищенный канал открыт на всех коммуникационных консолях.", "ВНИМАНИЕ: Страховка", SSstation.announcer.event_sounds[ANNOUNCER_SHUTTLE_INSURANCE] || ANNOUNCER_COMMAND_REPORT) // SPLURT EDIT - ORIGINAL: priority_announce("Incoming subspace communication. Secure channel opened at all communication consoles.", "Incoming Message", ANNOUNCER_COMMAND_REPORT)
