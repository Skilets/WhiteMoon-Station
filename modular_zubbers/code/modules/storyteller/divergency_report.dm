/datum/controller/subsystem/gamemode/proc/send_trait_report()
	...
	priority_announce("Поздравляем с началом смены, экипаж [station_name()]. Наш стажёр закончил оценку дивергенции и целей под вашу систему, отчёт с данными был отправлен на вашу коммуникационную консоль. Удачной смены!", "Диспетчерская Служба", ANNOUNCER_COMMAND_REPORT) // SPLURT EDIT
